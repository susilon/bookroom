<?php
/* Smarty version 3.1.32, created on 2021-02-19 10:00:43
  from 'D:\ano site\UI-skeletonhahuyy\Views\Skeleton\list_variation.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_602f29dbe4b531_97677599',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fff3cd9e388913b525e5e48f3c3ca8dea8dfdcfc' => 
    array (
      0 => 'D:\\ano site\\UI-skeletonhahuyy\\Views\\Skeleton\\list_variation.html',
      1 => 1613645282,
      2 => 'file',
    ),
  ),
...
function content_602f29dbe4b531_97677599 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_32613602f29dbd7d1a5_10238512', 'headcontent');
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_23823602f29dbdd0dc5_40791355', 'bodycontent');
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_26779602f29dbe3c8b0_14413547', 'scriptfooter');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "../Shared/portoku.master.html");
}
/* {block 'headcontent'} */
class Block_32613602f29dbd7d1a5_10238512 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'headcontent' => 
  array (
    0 => 'Block_32613602f29dbd7d1a5_10238512',
  ),
);
...
/* {/block 'headcontent'} */
/* {block 'bodycontent'} */
class Block_23823602f29dbdd0dc5_40791355 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodycontent' => 
  array (
    0 => 'Block_23823602f29dbdd0dc5_40791355',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
<section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">List Variation</h2>
                                <h4>Project Name : <?php echo $_smarty_tpl->tpl_vars['data_skeleton']->value['project_name'];?>
...
?>
                                            ...
                                            <!-- <th class="hidden-phone"><?php echo $_smarty_tpl->tpl_vars['data']->value['json_skeleton'];?>
</th> -->
...
<div id="modalPrimary2" class="modal-block modal-block-primary mfp-hide">
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title">Confirmation : <?php echo $_smarty_tpl->tpl_vars['data_skeleton']->value['project_name'];?>
</h2>
        ...
        <div class="panel-body">
            <div class="modal-wrapper">
                ...
                <div class="modal-text">
                    <!-- <h4>Are you sure want to delete variation "<span id="var_desc_p"></span>" ?</h4> -->
                    <!-- <span id="v_json_skeleton"></span> -->
                    <!-- <!-- <textarea class="form-control" rows="10" id="v_json_skeleton" data-plugin-textarea-autosize></textarea> -->
                     <!-- <!-- <span id="dialog_idx"class="hidden"></span> -->
                     <input type="text" class="form-control" id="v_json_skeleton">
                     <!-- <input type="hidden" class="form-control" id="project_key" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['project_key'];?>
"> -->
                </div>
            </div>
...
/* {/block 'bodycontent'} */
/* {block 'scriptfooter'} */
class Block_26779602f29dbe3c8b0_14413547 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'scriptfooter' => 
  array (
    0 => 'Block_26779602f29dbe3c8b0_14413547',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/Skeleton/form_variation/" + $project_key + "/" + $id;
    ...
    $(".c_button_view").click(function () {   
        ...
        $json_skeleton_view = JSON.stringify($(this).attr("json_skeleton"));

        

        $("#v_json_skeleton").val($json_skeleton_view);
        

        // alert($json_skeleton_view);
