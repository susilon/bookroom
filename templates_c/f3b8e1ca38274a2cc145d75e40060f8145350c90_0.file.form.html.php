<?php
/* Smarty version 3.1.32, created on 2020-12-09 20:08:53
  from 'D:\ano site\Assigners\Views\Secondassigner\form.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5fd0cc654deec1_23087478',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f3b8e1ca38274a2cc145d75e40060f8145350c90' => 
    array (
      0 => 'D:\\ano site\\Assigners\\Views\\Secondassigner\\form.html',
      1 => 1607518984,
      2 => 'file',
    ),
  ),
...
function content_5fd0cc654deec1_23087478 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_238175fd0cc654a8429_67331586', 'bodycontent');
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_248165fd0cc654d50e7_52117900', 'bodyfooter');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "../Shared/portoku.master.html");
}
/* {block 'bodycontent'} */
class Block_238175fd0cc654a8429_67331586 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodycontent' => 
  array (
    0 => 'Block_238175fd0cc654a8429_67331586',
  ),
);
...
<div class="form-group">
                        ...
                        <span class="show-grid-block">
                                <input type="text" placeholder=".Select PIC Project" class="c_view_pic form-control" required >
                        ...
                        <span class="">
                            <div class="checkbox-custom checkbox-primary">
                                <input type="checkbox"  id="is_my_project" name="is_my_project">
                                <label for="checkboxExample2">Assign with Task</label>
                            </div>
                            </span>
                        </div> -->
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <span class="show-grid-block">
                                <input type="text" name="dept_assigner" class="form-control" id="NTUserName" required >
...
">  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <span class="show-grid-block">
                                <input type="text" name="dept_cd" class="form-control" id="dept_cd" required > 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!-- <input type="text" style="display:none" name="task_desc" placeholder=".Select Task" class="form-control task_view" id="task_desc" required > -->
                            <input type="hidden" id="task_cek" placeholder=".Select Project" class="form-control" > 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <span class="show-grid-block">
                            <input type="text" name="task_desc" placeholder=".Select Task" class="form-control c_task_view" id="task_desc">
                            <input type="hidden" name="task_id" placeholder=".Select Project" class="form-control" id="task_id" >
                        ...
                        <div class="col-sm-10">
                            <div class="input-daterange input-group" data-plugin-datepicker>
                                <span class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control"  name="plan_start" id="plan_start" placeholder="<?php echo smarty_modifier_date_format(time(),"%m/%d/%Y");?>
"  >
                                        <span class="input-group-addon">to</span>
                                        <input type="text" class="form-control"  name="plan_end" id="plan_end" placeholder="<?php echo smarty_modifier_date_format(time(),"%m/%d/%Y");?>
" >
                             </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-daterange input-group" data-plugin-datepicker>
                                <span class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control"  name="actual_start" id="actual_start" placeholder="<?php echo smarty_modifier_date_format(time(),"%m/%d/%Y");?>
">
                                        <span class="input-group-addon">to</span>
                                        <input type="text" class="form-control"  name="actual_end" id="actual_end" placeholder="<?php echo smarty_modifier_date_format(time(),"%m/%d/%Y");?>
">
                             </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Remark Task : </label>
                        <div class="col-sm-10">
                        <span class="show-grid-block">
                                <textarea id="remark_task" name = "remark"  class="form-control" rows="3" data-plugin-maxlength="" maxlength="140"></textarea>
                            </span>
                        </div>
                    </div>
...
"><span class="label label-success">Remove</span></a>
                                                    ...
                                                    <a href="#" class="button c_button_add_task" dept_cd="<?php echo $_smarty_tpl->tpl_vars['data']->value['dept_cd'];?>
" pic_name="<?php echo $_smarty_tpl->tpl_vars['data']->value['dept_assigner'];?>
" id_ms_prj="<?php echo $_smarty_tpl->tpl_vars['data']->value['id_ms_prj'];?>
"><span class="label label-success">Task</span></a>
...
/* {/block 'bodycontent'} */
/* {block 'bodyfooter'} */
class Block_248165fd0cc654d50e7_52117900 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodyfooter' => 
  array (
    0 => 'Block_248165fd0cc654d50e7_52117900',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
function pick_task($dept_cd=null) {
	//-------------------Picker Task----------------------
    $('.c_task_view').bantinganPicker({
...
/Assigntopic/save_task_ajax" , data_task)
        ...
        $id_ms_prj = $("#id_ms_prj").val();
        // $dept_cd = $("#dept_cd").val();
        // $dept_assigner = $("#NTUserName").val();
        data_pic = { 
                          dept_assigner : $("#NTUserName").val(),
                          id_ms_prj : $("#id_ms_prj").val(),
                          dept_cd : $("#dept_cd").val(),
                          div_cd: $("#book_dte").val(),
                          remark: $("#assign_dept_remark").val()
                  	     };

        $.post( "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/Secondassigner/save" , data_pic)
        .done(function(response) 
            {
                alert(response.message);
                            // return false;
                            // $("#rowz").html("");
                            // $("#rowz").html(response.rowz);
                $("#NTUserName").val("");
                $("#dept_cd").val("");
                $("#assign_dept_remark").val("");

                            // $tambah_row = "<tr class='gradeA'><td class='center'>" + $dept_cd + "</td><td id_ms_prj='" + $id_ms_prj + "'>" + $dept_assigner + "</td><td><a href='#modalPrimary' class='modal-with-form a_modal c_button_remove' dept_cd='" + $dept_cd + "' pic_name='" + $dept_assigner + "' id_ms_prj='" + $id_ms_prj + "'><span class='label label-success'>Remove</span></a></td></tr>";
                            // alert($tambah_row);
                            // $("#rowz").append($tambah_row);

                if (response.is_exist=="no")
                    {
                        location.reload();
                            
                            // $.post("<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/secondassigner/refresh_rowz/" + $id_ms_prj)
                            // .done(function(data) 
                            //     {
                            //         $("#rowz").html("");
                            //         $("#rowz").html(data.rowz);
