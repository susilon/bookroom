<?php
/* Smarty version 3.1.32, created on 2019-12-02 16:06:37
  from 'C:\xampp\htdocs\Assigner\Views\Memointernal\bookform.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5de4d41dd8d3b2_75042273',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd797c4a028a3ccecec8fb706f6cc427cfd93edf2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Assigner\\Views\\Memointernal\\bookform.html',
      1 => 1575277572,
      2 => 'file',
    ),
  ),
...
function content_5de4d41dd8d3b2_75042273 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_90655de4d41da07aa8_79258994', 'bodycontent');
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_168785de4d41dd4f480_24200937', 'scriptfooter');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "../Shared/portoku.master.html");
}
/* {block 'bodycontent'} */
class Block_90655de4d41da07aa8_79258994 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodycontent' => 
  array (
    0 => 'Block_90655de4d41da07aa8_79258994',
  ),
);
  ...
  <div class="row">
                    ...
                    <div class="col-md-2">
                      <span class="show-grid-block">
                        ...
                        <form id="form1">
                        <div id="div_tombol1">
                        <button class="mb-xs mt-xs mr-xs btn btn-lgx btn-warning" id='tombol1' class="btn btn-primary" seq_number="<?php echo $_smarty_tpl->tpl_vars['next_seq_numb']->value;?>
" >GO</button>
                        </div>
                        </form>
                      </span>
...
">
                        <div id = "div_tombol2">
                        <button style="visibility:hidden" class="mb-xs mt-xs mr-xs btn btn-lgx btn-warning" id='tombol2' class="btn btn-primary" seq_number="<?php echo $_smarty_tpl->tpl_vars['next_seq_numb']->value;?>
" >Sure</button>
                    ...
                    <div class="col-md-8">
                      <span class="show-grid-block">
                        ...
                        <form id="form3">
                        <div id="div_tombol3">
                        <button style="visibility:hidden" class="mb-xs mt-xs mr-xs btn btn-lgx btn-warning" id='tombol3' class="btn btn-primary" seq_number="<?php echo $_smarty_tpl->tpl_vars['next_seq_numb']->value;?>
" >Cancel</button>
                        </div>
                        </form>
                      </span>
...
<div class="row show-grid" >
 ...
 <!-- Tabel MI No Idol==================================================== -->
<div class="col-md-3" id="div_cancel">

<form action="" class="form-horizontal" id="bantingantable-searchform">
    <div class="row show-grid">
      <div class="col-md-12">Recomended Number :</div>
    </div>
        <section class="panel">
          <div class="panel-body">
...
<div class="row show-grid">
 <div id="p_status3" class="col-md-2">MI Detail :</div>
...
/* {/block 'bodycontent'} */
/* {block 'scriptfooter'} */
class Block_168785de4d41dd4f480_24200937 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'scriptfooter' => 
  array (
    0 => 'Block_168785de4d41dd4f480_24200937',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/Memointernal/simpen_ajax/" + id_from_msnumber + "/" + tipe_simpan + "/" + seq_no_temp, dataygmaudikirim)
                      .done(function(data) 
                          {   
                              // alert("test");
                            // console.log(data.cek_message);
                              ...
                              if (data.cek_message == "not_exist")
                              {
                                  ...
                                  $("#div_tombol1").html("<button class='mb-xs mt-xs mr-xs btn btn-lgx btn-warning' id='tombol1' class='btn btn-primary'>GO</button>");

                                  $("#div_tombol2").html("<button style='visibility:hidden' class='mb-xs mt-xs mr-xs btn btn-lgx btn-warning' id='tombol2' class='btn btn-primary' seq_number='<?php echo $_smarty_tpl->tpl_vars['next_seq_numb']->value;?>
' >Sure</button>");

                                  $("#div_tombol3").html("<button style='visibility:hidden' class='mb-xs mt-xs mr-xs btn btn-lgx btn-warning' id='tombol3' class='btn btn-primary' seq_number='<?php echo $_smarty_tpl->tpl_vars['next_seq_numb']->value;?>
' >Cancel</button>");
                              ...
                              $("#div_tombol1").html("<div id='div_temp1' style='background-color: #eb9316;color: #ffffff' class='btn-lgx'>Execution</Div>");
                              $("#div_tombol2").html("<div id='div_temp2' style='background-color: #eb9316;color: #ffffff' class='btn-lgx'>Done</Div>");
                              $("#div_tombol3").html("<div id='div_temp3' style='background-color: #eb9316;color: #ffffff' class='btn-lgx'> MI No " + seq_no_temp + " successfuly Booked" + "</Div>");
                              $("#label_upper").html('Data Saved, Please Fill MI Detail and click "Save"');
...
/Memointernal/simpen_ajax/" + id_from_msnumber + "/" + tipe_simpan + "/" + code, dataygmaudikirim)
                      ...
                      //----------------------------------------------
                              ...
                              $("#div_tombol1").html("<div id='div_temp1' style='background-color: #eb9316;color: #ffffff' class='btn-lgx'>V</Div>");
                              $("#div_tombol2").html("<div id='div_temp2' style='background-color: #eb9316;color: #ffffff' class='btn-lgx'>Done</Div>");
                              $("#div_tombol3").html("<div id='div_temp3' style='background-color: #eb9316;color: #ffffff' class='btn-lgx'> MI No " + data.data['seq_numb'] + " successfuly Booked" + "</Div>");
