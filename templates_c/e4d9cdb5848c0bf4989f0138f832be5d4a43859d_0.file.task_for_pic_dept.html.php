<?php
/* Smarty version 3.1.32, created on 2020-04-30 11:26:59
  from 'D:\ano site\Assigners\Views\Assigntopic\task_for_pic_dept.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5eaa5393a88ef9_71955155',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e4d9cdb5848c0bf4989f0138f832be5d4a43859d' => 
    array (
      0 => 'D:\\ano site\\Assigners\\Views\\Assigntopic\\task_for_pic_dept.html',
      1 => 1588220811,
      2 => 'file',
    ),
  ),
...
function content_5eaa5393a88ef9_71955155 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_232415eaa53939d9ae6_15670692', 'headcontent');
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_65505eaa53939f0e22_76009543', 'bodycontent');
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_225615eaa5393a78d65_15195662', 'scriptfooter');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "../Shared/portoku.master.html");
}
/* {block 'headcontent'} */
class Block_232415eaa53939d9ae6_15670692 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'headcontent' => 
  array (
    0 => 'Block_232415eaa53939d9ae6_15670692',
  ),
);
...
/* {/block 'headcontent'} */
/* {block 'bodycontent'} */
class Block_65505eaa53939f0e22_76009543 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodycontent' => 
  array (
    0 => 'Block_65505eaa53939f0e22_76009543',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
...
" >Task
 ...
 - <?php echo $_smarty_tpl->tpl_vars['data']->value['dept_cd'];?>
                                            ...
                                            <td class="center hidden-phone">
                                            <a class="btn btn-default c_button_select" id_ms_prj="<?php echo $_smarty_tpl->tpl_vars['data']->value['id_ms_prj'];?>
" pic_name="<?php echo $_smarty_tpl->tpl_vars['data']->value['pic_name'];?>
"  dept_cd="<?php echo $_smarty_tpl->tpl_vars['data']->value['dept_cd'];?>
...
" >delete
                                            ...
                                            <td class="hidden-phone"><a class="btn btn-default c_button_remove" id_ms_prj="<?php echo $_smarty_tpl->tpl_vars['data']->value['id_ms_prj'];?>
" pic_name="<?php echo $_smarty_tpl->tpl_vars['data']->value['pic_name'];?>
...
" ><i class="fa fa-trash-o"></i> remove
                                            <a href="#modalPrimary" id="show_modal" class="modal-with-form a_modal" style="visibility:hidden" >Task
                                            </a> 
...
<div class="col-md-3">PIC Name
    <span class="show-grid-block">
        ...
        <input type="hidden" name="controller" class="form-control" value="task_for_pic_dept">
	</span>
</div>
...
/* {/block 'bodycontent'} */
/* {block 'scriptfooter'} */
class Block_225615eaa5393a78d65_15195662 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'scriptfooter' => 
  array (
    0 => 'Block_225615eaa5393a78d65_15195662',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    $(".c_button_assign").click(function()
	{
        ...
        $dept_cd_user = $("#share_dept_cd").text();

        if($dept_cd!=$dept_cd_user)
        {
            // alert($dept_cd_user);

            $title = 'Notification :',
	        $text = 'Sory, You only can add Task to dept ' + $dept_cd_user + ' (your own dept)',
	        $type = 'custom',
...
/Assigntopic/form/" + $id_ms_prj ;
    ...
    $(".c_button_remove").click(function()
	{
        ...
        if($dept_cd!=$dept_cd_user)
        {
            ...
            $title = 'Notification :',
	        $text = 'Sory, You only can remove dept ' + $dept_cd_user + ' Task (your own dept)',
	        $type = 'custom',
	        $addclass = 'notification-primary',
	        $icon = 'fa fa-twitter'
            notif($title,$text,$type,$addclass,$icon);
            ...
            // triger location.href = "modalPrimary";
            $link = $('#show_modal');
            $link[0].click()
...
// $("#modal_pic_name").text($pic_name);
        ...
        window.location = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/Assigntopic/delete_task/" + $id_ms_prj + "/" + $id + "/task_for_pic_dept";
    });

    $(".c_button_select").click(function () {   
        ...
        {
            $title = 'Notification :',
	        $text = 'Sory, You only can update Task to dept ' + $dept_cd_user + ' (your own dept)',
	        $type = 'custom',
	        $addclass = 'notification-primary',
	        $icon = 'fa fa-twitter'
            notif($title,$text,$type,$addclass,$icon);
        ...
        window.location = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/Assigntopic/taskdone/" + $id_ms_prj + "/" + $pic_name + "/" + $id + "/task_for_pic_dept" ;
        }
...
$(document).ready()
{
    ...
    //   var href = $('.c_button_remove').attr('href');
