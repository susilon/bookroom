<?php
/* Smarty version 3.1.32, created on 2021-11-07 22:43:14
  from 'D:\ano site\bookroom\Views\Bookroom\list_edit_bookroom.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_6187f412cd0592_63559081',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c7889f81b58c9d154ba5f06b8c76ee0e532de012' => 
    array (
      0 => 'D:\\ano site\\bookroom\\Views\\Bookroom\\list_edit_bookroom.html',
      1 => 1636299790,
      2 => 'file',
    ),
  ),
...
function content_6187f412cd0592_63559081 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_59536187f412c20030_45086083', 'headcontent');
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_231876187f412c2e671_50864709', 'bodycontent');
?>
 <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_162346187f412ca8f38_22563109', 'scriptfooter');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "../Shared/portoku.master.html");
}
/* {block 'headcontent'} */
class Block_59536187f412c20030_45086083 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'headcontent' => 
  array (
    0 => 'Block_59536187f412c20030_45086083',
  ),
);
...
/* {/block 'headcontent'} */
/* {block 'bodycontent'} */
class Block_231876187f412c2e671_50864709 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'bodycontent' => 
  array (
    0 => 'Block_231876187f412c2e671_50864709',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <!-- <div id="tanggal_book" onclick="refresh_list_room()" value="10-10-2021" data-plugin-datepicker data-plugin-skin="primary" > -->
            <label class="col-md-8 control-label"><?php echo $_smarty_tpl->tpl_vars['data_before']->value['subjects'];?>
</label>
        <!-- <input type="input" class="form-control" id="subject_before" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['subject'];?>
" disabled > -->
    </div>
</div>
...
<div class="form-group">
    ...
    <input type="hidden" class="form-control" id="id_bookroom" value="<?php echo $_smarty_tpl->tpl_vars['id_bookroom']->value;?>
" >
...
foreach ($_from as $_smarty_tpl->tpl_vars['data']->value) {
?>
                                            <tr   <?php if ($_smarty_tpl->tpl_vars['id_bookroom']->value == $_smarty_tpl->tpl_vars['data']->value['id_bookroom']) {?>bgcolor="aqua"<?php }?> class="gradeA">
                                            <td class="hidden-phone">
                                                <a class="open_form_book modal-with-form btn btn-warning" href="#modalForm" time_book="<?php echo $_smarty_tpl->tpl_vars['data']->value['time_book'];?>
...
" <?php if ($_smarty_tpl->tpl_vars['data']->value['cek_waktu'] == 'disable') {?>disabled<?php }?>><?php echo $_smarty_tpl->tpl_vars['data']->value['time_book'];?>
                                            ...
                                            <td  class="hidden-phone"><?php echo $_smarty_tpl->tpl_vars['data']->value['subjects'];?>
</td >
        ...
        <div class="panel-body">
            <div class="modal-wrapper">
                ...
                <div class="modal-text">
                    <h4>Silahkan Pilih data book yang akan di delete</h4>
                ...
                <table class="table mb-none">
                    ...
                    <tbody>
                        <tr class="gradeA" type="hidden" ></tr>
                            <td>
                                <a href="#" id="btn_row_eidt0"><i class="fa fa-pencil"></i></a>
                            </td>
...
<div id="modalForm" class="modal-block modal-block-lg mfp-hide">
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title">Boking Room (Mode : Edit)</h2>
        </header>
        <div class="panel-body">
            <form id="form_book">
            <!-- <form id="form_book" class="form-horizontal mb-lg" novalidate="novalidate"> -->
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <label class="control-label"><b>Before</b></label>
                            <!-- <label class="control-label"><b>Before</label> -->
                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['room_name'];?>
"  class="form-control" disabled>
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <label class="control-label"><b>After</b></label>
                            <!-- <input type="text" value="room name" class="form-control"> -->
                            <div>
                                <span class="show-grid-block">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>                                               
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_date'];?>
" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="control-label">Use Date</label>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="form-group">
                            <input type="text" class="form-control"  id="pick_date" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_time_start'];?>
" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <!-- <input type="text" value="use time start" class="form-control"> -->
                            <span class="show-grid-block">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>                                               
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_time_end'];?>
" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="col-sm-2">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>                                               
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <!-- <input type="text" id="subject_before" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['subjects'];?>
" class="form-control" disabled> -->
                            <textarea name = "subject"  class="form-control" rows="3" data-plugin-maxlength="" maxlength="140"><?php echo $_smarty_tpl->tpl_vars['data_before']->value['subjects'];?>
</textarea>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            ...
                            <textarea id = "subject"  class="form-control" rows="3" data-plugin-maxlength="" placeholder="" maxlength="140"><?php echo $_smarty_tpl->tpl_vars['data_before']->value['subjects'];?>
</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <textarea name = "subject"  class="form-control" rows="3" data-plugin-maxlength="" maxlength="140"><?php echo $_smarty_tpl->tpl_vars['data_before']->value['remark'];?>
</textarea>
                            <!-- <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_time_end'];?>
" class="form-control" disabled> -->
                        </div>
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <!-- <input type="text" value="" class="form-control"> -->
                            <textarea id = "remark"  class="form-control" rows="3" data-plugin-maxlength="" maxlength="140"><?php echo $_smarty_tpl->tpl_vars['data_before']->value['remark'];?>
</textarea>
                        </div>
                    </div>
                </div>
...
<!-- ========================Original============= -->
                ...
                <!-- <div class="form-group">
                    <label class="col-sm-3 control-label"><b>Current :</b></label>
                </div>
                <div class="form-group">
                    
                    <label class="col-sm-3 control-label">Subject</label>
                    <div class="col-sm-9">
                        <input type="input" id="subject_before" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['subject'];?>
" disabled/>
                    </div>
                    <label class="col-sm-3 control-label">Room Name</label>
                    <div class="col-sm-9">
                        <input type="input" id="room_name_before" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['room_name'];?>
" disabled/>
                    </div>
                    <label class="col-sm-3 control-label">Use Date</label>
                    <div class="col-sm-9">
                        <input type="input" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_date'];?>
" disabled/>
                    </div>
                    <label class="col-sm-3 control-label">Time Start</label>
                    <div class="col-sm-9">
                        <input type="input" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_time_start'];?>
" disabled/>
                    </div>
                    <label class="col-sm-3 control-label">Time End</label>
                    <div class="col-sm-9">
                        <input type="input" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['data_before']->value['use_time_end'];?>
" disabled/>
                    </div>
                ...
                <div class="form-group" >
                    <label class="col-sm-3 control-label"><b>Edit Become :</b></label>
                </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>                                               
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Use Date</label>
                    <div class="col-sm-9">
                        <input type="input" name="pick_date" class="form-control" disabled/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Time Start</label>
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    ...
                    <button class="btn btn-default modal-dismiss">Cancel</button>
                    <button type="button" class="btn btn-success" name="btn" id="submitBtn" data-toggle="modal" data-target="#confirm-submit">Save</button>                                        
...
/* {/block 'bodycontent'} */
/* {block 'scriptfooter'} */
class Block_162346187f412ca8f38_22563109 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'scriptfooter' => 
  array (
    0 => 'Block_162346187f412ca8f38_22563109',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/bookroom/listbookroom/" ;
    ...
    var text_time_end = end.options[end.selectedIndex].text;
        ...
        // var tgl = getDate(datelist);
        $id_room = $("#pick_room").val();
        $id_bookroom_before = $("#id_bookroom").val();
        d = new Date($datelist);
        ...
        dataygmaudikirim = {
                          ...
                          subject : $("#subject").val(),
                          remark : $("#remark").val(),
                          id_bookroom_before : $id_bookroom_before
                      ...
                      $.post("<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/bookroom/simpan_edit_bookroom_ajax/", dataygmaudikirim)
                      .done(function(data) 
                          {   
                            console.log(data.message + 'ini console log');
    ...
    function refresh_list_room(){
        ...
        if($bookdate!='NaN/NaN/NaN'){
            if ($bookdate!=$("#use_date").val())
            {
                ...
                // alert($bookdate);
                window.location = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/bookroom/list_edit_bookroom/" + $id_bookroom + "/" + $room_name +"/" + $bookdate ;
            }
        }
...
// $("#room_name_before").val($("#room_name").text());
