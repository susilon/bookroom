...
(function( $ ) {
	...
	*/
	...
	Morris.Line({
		...
		labels: ['Series A', 'Series B', 'Series C', 'Series D', 'Series E', 'Series F', 'Series G', 'Series H', 'Series I', 'Series J'],
		hideHover: true,
		lineColors: ['#0088cc', '#734ba9','#FFA500', '#734ba9','#0088cc', '#734ba9','#0088cc', '#734ba9','#0088cc', '#734ba9'],
	});
